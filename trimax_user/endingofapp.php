...
<div class="container-fluid">
    <div class="row wow bounce">
        <ul class="nav nav-tabs navbar-inverse nav-pills navbar-fixed-top sol">
            <li><a href="userenter.php"><strong class="dos"><span class="glyphicon glyphicon-home trf" aria-hidden="true"></span> Home</strong></a> </li>
...
<div class="container-fluid">
   <div class="col-md-12">
       <div class="panel panel-primary">
           <h1 style="text-align:center;">trimax</h1>
           <p align="right">plese print this coupoun</p>
           <div class="container">
               <h3 class="">Name::--   <?php $name=$_SESSION['name'];echo "$name";?></h3>
               <hr>
               <h3 class="">phone number::--   <?php $phone=$_SESSION['phone'];echo "$phone";?></h3>
               <hr>
               <h3 class="">Adress::--  <?php $adress=$_SESSION['adress']; echo "$adress";?></h3>
               <hr>
               <h3 class="">promocode::--  <?php $pop = $_SESSION['promo'];echo "$pop";?></h3>
               <hr>
