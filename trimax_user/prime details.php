...
<div class="container-fluid">
    <div class="panel panel-primary">
        <div class="panel-heading"><b>Most Welcome in hotel prime palace</b></div>
        <div class="col-md-12">
            <br>
            <br>
            <img src="prime.jpeg" class="img-circle img-responsive yut">
            <h1 class="text lol">Trimax</h1>
        </div>
        <div class="panel-body">
            <li>hotel prime place is best hotel in kadi</li>
            <li>when you book the <b>hotel through the trimax so you give the 50% cashback</b></li>
            <li>hotel prime palace given the best food his customers</li>
...
if(isset($_POST['apply']))
{
    ...
    }$query = "INSERT INTO promocode(promocode,user,hotel) VALUES ('$pop','$user','hotel prime')";
