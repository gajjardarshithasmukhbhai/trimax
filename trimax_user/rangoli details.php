...
<head>
    ...
    <style type="text/css">
        ...
        .sol
        {
            ...
            box-shadow: 1px 1px 1px 1px #b2dba1;
        }
        .lom
        {
...
<div class="container-fluid">
    ...
    <div class="panel panel-primary">
        <div class="panel-heading"><b>Most Welcome in hotel morli</b></div>
        <div class="col-md-12">
            <br>
            <br>
            <img src="pexels-photo-594077.jpeg" class="img-circle img-responsive yut">
            <h1 class="text lol">Trimax</h1>
        </div>
        <div class="panel-body">
            <li>hotel morli is best hotel in kadi</li>
            <li>when you book the <b>hotel through the trimax so you give the 20% cashback</b></li>
            <li>hotel morli given the home delivery for his customer</li>
            <li><b>If you have a meal in the hotel by trimax you will get a vouchar </b></li>
            <form class="navbar-form navbar-right">
                <div class="form-group">
                    <input type="text" class="form-control" placeholder="apply trimax promocode">
                </div>
                <button type="button" class="btn lom" >apply</button>
            </form>
            <form action="bookingmorli.html">
                <br>
                <br>
                <button type="submit" class="btn btn-danger" value="rangotri palce">Book the hotel</button>
            </form>
            </ul>
        </div>
    </div>
...
{
    $_SESSION['gangotri'] = $_POST['apply'];
    $hji=$_SESSION['gangotri'];
    $user=$_SESSION['uname'];
    ...
    {
        case 'trimaxlove':
            $query = "INSERT INTO promocode(promocode,user,hotel) VALUES ('$pop','$user','$hji')";
