    ...
    <div class="row">
        <div class="col-md-6">
            <div class="panel panel-primary">
                <div class="panel-heading">Trimax</div>
                <div class="panel-body">
                    <ul class="wow fadeInDown">
                        <li>Trimax is kadi's best food service</li>
                        <li>I have pround Trimax cover up the 12,000 house to the food service</li>
                        <li>Trimax give the Vochar so coustmer enjoy free food and given discount</li>
                        <li>Trimax cover the 12 hotel in kadi like Morli,rangloi,gagotri and other</li>
                        <li>After dinner  user will be given the review so Trimax tell hotel and solve problem of coustomer</li>
                        <li>the coustomer book hotel table and so that coustomer not wait outside</li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="panel panel-primary">
                <div class="panel panel-heading">Terms and coditions</div>
                <div class="panel-body">
                    <ul class="wow fadeInDown">
                        <li>the Trimax vouchar period is only week</li>
                        <li>ther vochar Id number is important</li>
                        <li>user stolen the vochar Id so that not use second time</li>
                        <li>user give the half money to the hotel so coustomer given penalty</li>
                        <li>your support is much more impotant</li>
                    </ul>
                </div>
            </div>
        </div>
