...
<div class="container-fluid">
    <div class="row">
        <ul class="nav nav-tabs navbar-inverse nav-pills navbar-fixed-top sol">
            ...
            <li><a href="login.php"><strong class="dos"><span class="glyphicon glyphicon-user trf"></span> login</strong></a></li>
            ...
            <div class="well qww ">
                <form class="form-horizontal" method="post" >
                    <div class="form-group">
                        <label class="control-label col-sm-2">Courier ID:</label>
                        <div class="col-sm-10" >
...
if(isset($_POST['dsubmit']))
{
    ...
    $query="select *from trimax_courier WHERE courier_ID='$user' && password='$password'";
    $result=mysqli_query($con,$query);
    $rowcount=mysqli_num_rows($result);
    if ($rowcount == TRUE)
    {
        header('location:courierenter.php');
    }
    else
    {
        echo    "<p class='wwq'>your username_courier is not valid</p>";
