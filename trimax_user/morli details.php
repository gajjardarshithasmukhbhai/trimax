...
<div class="container-fluid">
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <form action="bookingmorli.php">
                <br>
                <br>
                <button type="submit" class="btn btn-success" name="booking">Book the hotel</button>
            </form>
...
if(isset($_POST['apply']))
{
    ...
    }$query = "INSERT INTO promocode(promocode,user,hotel) VALUES ('$pop','$user','hotel morli')";
