...
<div class="container-fluid">
    <div class="panel panel-primary">
        <div class="panel-heading"><b>Most Welcome in hotel gangotri</b></div>
        <div class="col-md-12">
            <br>
            <br>
            <img src="mount-wilbur-3032430_1920.jpg" class="img-circle img-responsive yut">
            <h1 class="text lol">Trimax</h1>
        </div>
        <div class="panel-body">
                <li>hotel gangori place is best hotel in kadi</li>
                <li>when you book the <b>hotel through the trimax so you give the 50% cashback</b></li>
                <li>hotel gangotri given the home delivery for his customer</li>
            ...
            <form action="bookinggangotripalace.php">
                    <br>
                    <br>
...
if(isset($_POST['apply']))
{
    ...
    }$query = "INSERT INTO promocode(promocode,user,hotel) VALUES ('$pop','$user','hotel gangotri')";
