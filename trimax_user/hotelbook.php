    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="panel-body">
                <b>Adress:-</b>
                <ul>
                    <li>pajarapor near the cera centryiware,kadi</li>
                 </ul>
                <form action="hotel%20gangotri%20details.php">
                  <button type="submit" class="btn btn-success uyt">Book</button>
                </form>
            </div>
            </div>
        </div>
        <div class="col-md-6">
            ...
            <div class=" panel-body">
                <b>Adress:-</b>
                <ul>
                    <li>pajaropor near the start line showroom</li>
                </ul>
        ...
        <div class="col-md-6">
            <div class="panel panel-primary">
                ...
                <div class=" panel-body">
                    <b>Adress:-</b>
                    <ul>
                        <li>near the shefali theater nanikadi</li>
                    </ul>
        ...
        <div class="col-md-6">
            <div class="panel panel-primary">
                ...
                <div class=" panel-body">
                    <b>Adress:-</b>
                    <ul>
                        <li>nani kadi near the ramji mandir</li>
                    </ul>
                    <form action="anmoldetails.php">
                        <button type="submit" class="btn btn-success uyt">Book</button>
                    </form>
                </div>
            </div>
        ...
        <div class="col-md-6">
            <div class="panel panel-primary">
                ...
                <div class=" panel-body">
                    <b>Adress:-</b>
                    <ul>
                        <li>near the ugvcl</li>
                    </ul>
                    <form action="pizzahuntdetails.php">
                        <button type="submit" class="btn btn-success uyt">Book</button>
                    </form>
                </div>
            </div>
        ...
        <div class="col-md-6">
            <div class="panel panel-primary">
                ...
                <div class=" panel-body">
                    <b>Adress:-</b>
                    <ul>
                        <li>near the pajarapol and cera cenetryware from 1.3 km this side </li>
                    </ul>
