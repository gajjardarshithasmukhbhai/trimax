...
<div class="container-fluid">
    <div class="row">
        <ul class="nav nav-tabs navbar-inverse nav-pills navbar-fixed-top sol">
            <li><a href="index.php"><strong class="dos"><span class="glyphicon glyphicon-home trf"></span> Home</strong></a> </li>
            <li><a href="login%202.php"><strong class="dos"><span class="glyphicon glyphicon-user frt"></span> login</strong></a></li>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-primary">
                <div class="panel panel-heading"><strong>About this web application</strong></div>
                <div class="panel panel-body">
                    <strong>Name:</strong><p>Gajjar Darshit Hasmukhbhai</p>
                    <strong>devloper:</strong><p>I am the Goverment Engineering College,Bhavnagar.I am current 4th sem.I want to became like full stack devloper</p>
                    <strong>experince:</strong><p>0-year fresher</p>
                    <strong>adress:</strong><p>E-204 vinod tower shrinath recendency,kadi</p>
                </div>
            </div>
        </div>
    </div>
