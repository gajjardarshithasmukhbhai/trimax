...
<div class="container-fluid">
    <div class="panel panel-primary">
        <div class="panel-heading"><b>Most Welcome in hotel Anmol</b></div>
        <div class="col-md-12">
            <br>
            <br>
            <img src="anmol%20hotel.jpeg" class="img-circle img-responsive yut">
            <h1 class="text lol">Trimax</h1>
        </div>
        <div class="panel-body">
            <li>hotel Anmol is best hotel in kadi</li>
            <li>when you book the <b>hotel through the trimax so you give the 10% cashback</b></li>
            <li>hotel Anmol given the best food his customers</li>
            <li><b>If you have a meal in the hotel by trimax you have benifits</b></li>
...
if(isset($_POST['apply']))
{
    ...
    }$query = "INSERT INTO promocode(promocode,user,hotel) VALUES ('$pop','$user','hotel anmol')";
