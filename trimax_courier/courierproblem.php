...
<div class="container-fluid">
    <div class="row">
        <ul class="nav nav-tabs navbar-inverse nav-pills navbar-fixed-top sol">
            ...
            <li><a href="courierenter.php"><strong class="dos"><span class="glyphicon glyphicon-record trf"></span>customer courier</strong></a></li>
...
?>
<h1>trimax customer problem:</h1>
<br>
<form  method="post">
<table class="table table-bordered table-hover ola">
    <thead>
    <th>customerName</th>
    <th>deleivery problem</th>
    <th>operation</th>
    </thead>
    <tbody class="rew">
    <td> <div class="form-group">
            <div class="col-lg-10">
                <input type="text"  class="form-control" placeholder="customer Name" name="rdp" required/>
                <br>
            </div>
        </div>
    </td>
    <td>
        <div class="form-group">
            <div class="col-lg-10">
                <input type="text"  class="form-control" placeholder="delievry problem" name="dpr" required/>
                <br>
            </div>
        </div>
    </td>
...
if(isset($_POST['insert']))
{
    $rty=$_POST['rdp'];
    $mln=$_POST['dpr'];
    $query="INSERT INTO `couurier_problem`(`user`, `courier_problem`) VALUES ('$rty','$mln')";
