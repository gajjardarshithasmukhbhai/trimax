...
<head>
    ...
    <style type="text/css">
        ...
        {
            background-size: cover;
            background-image: url("pizza design.png");
        }
    </style>
</head>
<body>
...
<div class="container-fluid ">
    <div class="row rte">
        <div class="panel panel-primary lll">
            <div class="panel-body">
                <div class="col-md-4">
                    <form action="hotel%20gangotri%20adress.php">
                        <input type="checkbox"><img src="pizza%20icon.png" class="rte">
                        <br>
                        <input type="checkbox"><img src="pizza%20icon.png" class="rte">
                        <br>
                        <input type="checkbox"><img src="pizza%20icon.png" class="rte">
